...
describe('Desafios de manipulação de tabelas', () => {
  ...
  describe('Queries de inserção', () => {
    ...
    describe.only('Adicione ao `order_details` uma linha com os seguintes dados: `order_id`: 69, `product_id`: 80, `quantity`: 15.0000, `unit_price`: 15.0000, `discount`: 0, `status_id`: 2, `date_allocated`: NULL, `purchase_order_id`: NULL e `inventory_id`: 129', () => {
    ...
    describe.only('Adicione, com um único `INSERT`, duas linhas ao `order_details` com os mesmos dados. Esses dados são novamente os mesmos do requisito 20', () => {
  ...
  describe('Queries de deleção', () => {
    ...
    describe.only('Delete todos os dados em que a `unit_price` da tabela `order_details` seja menor que 10.0000', () => {
    ...
    describe.only('Delete todos os dados em que a `unit_price` da tabela `order_details` seja maior que 10.0000', () => {
    ...
    describe.only('Delete todos os dados da tabela `order_details`', () => {
